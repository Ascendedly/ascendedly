        ...
        <div className="hidden items-center gap-1 lg:flex">
          ...
          <div className="flex items-center">
            <Link
              href="/services"
              className={cn(
                "rounded-md py-2 pl-3 pr-0.5 text-sm font-medium text-muted-foreground transition-colors hover:text-foreground",
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button
                  ...
                  className={cn(
                    "-ml-0.5 inline-flex h-8 w-5 items-center justify-center rounded-md text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
                    servicesActive && "text-foreground"
                  )}
                >
              ...
              <div className="mt-8 flex flex-col gap-1">
                ...
                <div className="px-2">
                  <SheetClose asChild>
                    <Link
                      href="/services"
                      className="block rounded-lg py-3 text-base font-medium text-foreground hover:bg-slate-100"
                    >
                      Services
                    </Link>
                  </SheetClose>
